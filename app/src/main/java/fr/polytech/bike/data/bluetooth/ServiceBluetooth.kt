...
class ServiceBluetooth : Service() {
    ...
    override fun onCreate() {
        ...
        val notificationChannel = NotificationChannel(
            ServiceBluetooth::class.java.simpleName,
        ...
        val notification = NotificationCompat.Builder(this, ServiceBluetooth::class.java.simpleName)
    ...
    private inner class ClientManager : BleManager(this@ServiceBluetooth) {
